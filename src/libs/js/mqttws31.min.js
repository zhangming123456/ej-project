...
Paho.MQTT = function (u) {
  ...
  var H = function (a, b, c) {
    ...
    this.isReset = !1
    var h = (new n(12)).encode(), e = function (a) {return function () {return d.apply(a)}},
  ...
  var I = function (a, b, c, h) {
    ...
    this._setOnConnectionLost = function (a) {if ('function' === typeof a) l.onConnectionLost = a else throw Error(f(g.INVALID_TYPE, [typeof a, 'onConnectionLost']))}
    this._getOnMessageDelivered = function () {return l.onMessageDelivered}
    this._setOnMessageDelivered = function (a) {if ('function' === typeof a) l.onMessageDelivered = a else throw Error(f(g.INVALID_TYPE, [typeof a, 'onMessageDelivered']))}
    this._getOnMessageArrived =
      function () {return l.onMessageArrived}
    this._setOnMessageArrived = function (a) {if ('function' === typeof a) l.onMessageArrived = a else throw Error(f(g.INVALID_TYPE, [typeof a, 'onMessageArrived']))}
    this._getTrace = function () {return l.traceFunction}
    this._setTrace = function (a) {if ('function' === typeof a) l.traceFunction = a else throw Error(f(g.INVALID_TYPE, [typeof a, 'onTrace']))}
    this.connect = function (a) {
      ...
      if (a.hosts) {
        ...
        for (var b = !1, d = 0; d < a.hosts.length; d++) {
          ...
          if (/^(wss?):\/\/((\[(.+)\])|([^\/]+?))(:(\d+))?(\/.*)$/.test(a.hosts[d]))if (0 == d) b = !0 else {if (!b)throw Error(f(g.INVALID_ARGUMENT, [a.hosts[d], 'connectOptions.hosts[' + d + ']']))} else if (b)throw Error(f(g.INVALID_ARGUMENT, [a.hosts[d], 'connectOptions.hosts[' +
          d + ']']))
        }
  ...
  var x = function (a) {
    ...
    this._setDestinationName = function (a) {if ('string' === typeof a) c = a else throw Error(f(g.INVALID_ARGUMENT, [a, 'newDestinationName']))}
    var h = 0
    ...
    this._setRetained = function (a) {if ('boolean' === typeof a) e = a else throw Error(f(g.INVALID_ARGUMENT, [a, 'newRetained']))}
    var d = !1
